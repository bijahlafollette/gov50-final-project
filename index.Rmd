...
As we can see the treatment effect of having a larger sample size reduced polling error by 2.7 points for this dataset. To see if this is statisticallty signigant or just do to random chance I will run a p value test
...
mediabias_summary
  ggplot(mediabias_summary, aes(x = Methodology, y = avg.error)) +
